...
/// Default `submit_form` handler for the customer app.
///
/// This is intentionally non-networking for now:
/// - emits a PII-safe diagnostic metric
/// - returns success
///
/// When services are ready, replace this with a real implementation that calls
/// a customer API (still bounded + policy-controlled).
