...
SchemaWidgetRegistry buildProviderComponentRegistry({
  ...
  registerRowSchemaComponent(registry: registry, context: componentContext);
  registerColumnSchemaComponent(registry: registry, context: componentContext);
  registerStackSchemaComponent(registry: registry, context: componentContext);
  registerWrapSchemaComponent(registry: registry, context: componentContext);
  registerPaddingSchemaComponent(registry: registry, context: componentContext);
  registerAlignSchemaComponent(registry: registry, context: componentContext);
  registerSizedBoxSchemaComponent(
    registry: registry,
    context: componentContext,
  );
  registerExpandedSchemaComponent(
    registry: registry,
    context: componentContext,
  );
